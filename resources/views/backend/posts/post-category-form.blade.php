<div class="box box-primary">
      ...
      <form class="form-horizontal" name="frmAddCategory" id="frmAddCategory" action="{{url('/admin/post/store-category')}}" method="post">
        @if(!empty($editcat))
          <input type="hidden" name="catid" value="{{ $editcat->id }}">
        @endif
        <input type="hidden" name="categoryType" value="post">
        <div class="box-body">
            <div class="form-group">
              <label for="catName" class="col-sm-12 control-label lft-align">Category</label>
              <div class="col-sm-12">
                <input type="text" class="form-control" name="catName" id="title" placeholder="Category name"

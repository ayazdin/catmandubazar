...
?>
  ...
  <form class="form-horizontal" name="frmAddPost" action="{{url('/admin/product/store')}}" method="post">

		<div class="row">
			<div class="col-xs-8">
        @include('backend.traits.product-editor')

        @include('backend.traits.product-image')

        @include('backend.traits.product-option-new')

			</div>

      <div class="col-xs-4">
        @include('backend.sidebar.publish')

        @include('backend.sidebar.product-category')

        <?php /*include('admin.sidebar.product-home-slider')*/?>

        @include('backend.sidebar.product-featured-image')

        @include('backend.sidebar.product-attribute')

        @include('backend.sidebar.product-seo')

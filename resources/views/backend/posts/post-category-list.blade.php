  ...
  <div class="box box-primary collapsed-box">
    <div class="box-header with-border">
      <h3 class="box-title">{{$cat['name']}} -
        <a href="{{url('/admin/post/category/add/'.$cat['id'])}}">Edit</a> |
        <a href="{{url('/admin/post/category/delete/'.$cat['id'])}}">Delete</a>
      </h3>
      ...
      <table class="table table-hover">
        ...
        <tbody>
          ...
          <tr data-toggle="collapse" data-target="#accordion{{$sb['id']}}" class="clickable">
            ...
            <td>{{$sb['slug']}}</td>
            <td>
              <a href="{{url('/admin/post/category/add/'.$sb['id'])}}">Edit</a> |
              <a href="{{url('/admin/post/category/delete/'.$sb['id'])}}">Delete</a>
            </td>
          </tr>

<?php
$author_post="";$enteredby="";$keywords="";$metadesc="";$category="";$brand="";
if(!empty($post))
{
...
@section('content')
    <div class="content-wrapper">
        ...
        <form class="form-horizontal" name="frmAddPost" action="/admin/price/storeProduct" method="post">
                ...
                <div class="row">
                    <div class="col-xs-8">
                        <div class="box box-primary">
                            ...
                            <input type="hidden" name="ctype" value="price">
                                            ...
                                            @if(!empty($categories))
                                                <ul>
                                                    @foreach($categories as $category)
                                                        <li>
                                                            <label><input type="checkbox" name="category" value="{!! $category->id !!}" <?php echo(isset($c)&&(($c)== $category->id))?"checked":""; ?>></label>
                                                            {!! $category->name !!}
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            ...
                                            @if(!empty($brands))
                                                    <ul>
                                                        @foreach($brands as $brand)
                                                            <li>
                                                                <label><input type="checkbox" name="brand" value="{!! $brand->id !!}" <?php echo(isset($b)&&(($b)== $brand->id))?"checked":""; ?>></label>
                                                                {!! $brand->title !!}
                                                            </li>
                                                        @endforeach
                                                    </ul>

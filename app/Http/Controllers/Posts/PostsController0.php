...
class PostsController extends Controller
{
    ...
    public function indexProduct()
    {
      ...
      //print_r($products);
      return view('yala-admin.posts.products')->with('products', $products);
    }
    ...
    public function createProduct()
    {
        ...
        return view('yala-admin.posts.add-product')->with('ddlCat', $ddlCat)
                                                    ->with('proType', $typeLi)
    ...
    public function editProduct($id)
    {
        ...
        return view('yala-admin.posts.add-product')->with('post', $post)
    ...
    public function createProductType($id='')
    {
        ...
        {
          $editcat = Postcat::where('id', $id)->first();
          return view('yala-admin.posts.add-product-type')->with('postcat', $postcat)
                                                      ->with('editcat', $editcat)
                                                      ->with('subcategories', $subcategories)
        ...
        try{
            ...
            for($iCo=0;$iCo<$priceSelCount;$iCo++)
            {
              $temp = [];
               ...
               {
                 $field = preg_replace('/[^A-Z0-9]+/i', '', strtolower($opn));
    ...
    public function getProductOrderList()
    {
      ...
      $orders = DB::table('carts')
                      ...
                      ->paginate(25);
      //print_r($orders);exit;
      return view('yala-admin.posts.product-orders')->with('orders', $orders);
    }
    ...
    public function getProductOrderView($orderid)
    {
      ...
      //print_r($orders);exit;
      return view('yala-admin.posts.product-order-view')->with('orders', $orders)
